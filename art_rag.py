...
def launch_gui():
    ...
    class ArtRagIngestApp(ctk.CTk):
        ...
        def _build_settings_tab(self, parent):
            ...
            ctk.CTkLabel(models_frame, text="Detected Ollama models", font=FONT_LABEL).grid(
                row=0, column=0, padx=15, pady=(12, 8), sticky="w"
            )
            ...
            ctk.CTkButton(
                models_frame, text="List installed models (Ollama)", command=self._settings_list_models
